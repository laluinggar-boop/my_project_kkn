    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        body {
            ...
            padding-top: 130px; /* Sedikit ditambah agar tidak terlalu mepet navbar */
        }

        /* --- UPDATE PENTING: MENYAJAJARKAN CONTAINER DENGAN NAVBAR --- */
        .container { 
            /* Samakan persis dengan ukuran Navbar */
            max-width: 1100px; 
            width: 95%; 
            margin: 0 auto; 
            
            /* Samakan padding-left dengan navbar (24px) agar teks lurus dengan logo */
            padding: 0 24px; 
        }
        ...
        nav {
            ...
            /* Padding ini yang menjadi acuan kesejajaran */
        ...
        .detail-title {
            ...
            /* Memastikan tidak ada margin negatif yang menggeser teks */
            margin-left: 0; 
        }
        ...
        .focus-list li::before {
            content: "•"; position: absolute; left: 0; color: #1e293b; font-weight: bold; font-size: 1.2rem; line-height: 1.5;
        }
...
<body>
    ...
    <nav>
        ...
        <div class="nav-links">
             <a href="beranda.html">Beranda</a><a href="tentang_kami.html">Tentang Kami</a><a href="program.html">Program</a>
            <a href="donasi.html">Donasi</a><a href="galeri.html">Galeri & Dampak</a><a href="kontak.html">Kontak</a>
        </div>
        <a href="daftar.html" class="btn-nav-donasi">Daftar Sekarang</a>
    </nav>
